...
class AnnualReportController extends Controller {
    ...
    public function exportannuallyreportExcel($request, $response) {
        try {
            ...
            $filename = 'MIS_Report-Annually_' . '_' . date('YmdHis') . '.xlsx';
...
//        
    ...
    private function generatePower2Excel($objPHPExcel, $condition, $region) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A4', ' ปี ' . ($condition['YearFrom'] + 543) . ' มีการเคลื่อนไหวของพนักงานและลูกจ้าง จำนวน  ' . $sum . '  ตำแหน่ง ดังนี้');
    ...
    private function generateVeterinaryExcel($objPHPExcel, $condition, $region) {
        ...
        $objPHPExcel->createSheet($sheet);
        $objPHPExcel->setActiveSheetIndex($sheet);
        $data = VeterinaryController::getAnnuallyDataList($condition, $region);
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A6', '                        ปี ' . ($condition['YearFrom'] + 543) . ' มีโคเข้ารับการบริการสัตวแพทย์ จำนวน ' . number_format($data['Summary']['SummaryCurrentCow'], 2, '.', ',') . ' ตัว รายได้ ' . number_format($data['Summary']['SummaryCurrentService'], 2, '.', ',') . '  บาท');
...
//tb header
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B10', ' ปี ' . ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->mergeCells('B10:C10');
        $objPHPExcel->getActiveSheet()->setCellValue('D10', ' ปี ' . ($condition['YearFrom'] + 542));
...
//        );
    ...
    private function generateInseminationExcel($objPHPExcel, $condition, $region) {
        ...
        $objPHPExcel->createSheet($sheet);
        $objPHPExcel->setActiveSheetIndex($sheet);
        $data = InseminationController::getAnnuallyDataList($condition, $region);
        $showm = 0;
        $showy = $condition['YearFrom'];
        $start = $condition['MonthTo'];
        if ($condition['MonthTo'] < 10) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A6', '                       ปี ' . ($condition['YearFrom'] + 543) . ' มีโคเข้ารับการบริการผสมเทียม จำนวน ' . number_format($data['Summary']['SummaryCurrentCowService'], 2, '.', ',') . ' ตัว รายได้ ' . number_format($data['Summary']['SummaryCurrentIncomeService'], 2, '.', ',') . '  บาท ');
...
//        );
    ...
    private function generateMineralExcel($objPHPExcel, $condition, $region) {
        ...
        $objPHPExcel->createSheet($sheet);
        $objPHPExcel->setActiveSheetIndex($sheet);
        $data = MineralController::getAnnuallyDataListbymaster($condition, $region);
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                        ปี ' . ($condition['YearFrom'] + 543) . ' มีจำหน่ายอาหารสัตว์ ปริมาณ ' . number_format($data['Summary']['SummaryCurrentMineralAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['Summary']['SummaryCurrentMineralIncome'], 2, '.', ',') . '  บาท ');
...
//tb header
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B9', ' ปี ' . ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->mergeCells('B9:C9');
        $objPHPExcel->getActiveSheet()->setCellValue('D9', ' ปี ' . ($condition['YearFrom'] + 542));
...
//        );
    ...
    private function generateTrainingCowbreedExcel($objPHPExcel, $condition, $region) {
        ...
        $data = TrainingCowBreedController::getAnnuallyDataList($condition, $region);
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                        ปี ' . ($condition['YearFrom'] + 543) . ' มีการฝึกอบรมทั้งสิ้น  ' . number_format($data['Summary']['SummaryCurrentCowBreedAmount'], 2, '.', ',') . '  ราย มูลค่า ' . number_format($data['Summary']['SummaryCurrentCowBreedIncome'], 2, '.', ',') . '  บาท ');
...
//        );
    ...
    private function generateTravelExcel($objPHPExcel, $condition, $region) {
        ...
        $data = TravelController::getAnnuallyDataListreport($condition, $region);
//        print_r($data);
//        die();
        $showm = 0;
        $showy = $condition['YearFrom'];
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                       ปี ' . ($condition['YearFrom'] + 543) . '  มีผู้ท่องเที่ยวเชิงเกษตร จำนวน ' . number_format($data['Summary']['SummaryCurrentTravelAmount'], 2, '.', ',') . '  ราย มูลค่า ' . number_format($data['Summary']['SummaryCurrentTravelIncome'], 2, '.', ',') . '  บาท ');
...
//        );
    ...
    private function generateSpermSaleExcel($objPHPExcel, $condition, $region) {
        ...
        $objPHPExcel->createSheet($sheet);
        $objPHPExcel->setActiveSheetIndex($sheet);
        $data = SpermSaleController::getAnnuallyDataListreport($condition, $region);
        $objPHPExcel->getActiveSheet()->setTitle("2.5 ปัจจัยการผลิต");
        $objPHPExcel->getActiveSheet()->setCellValue('A3', '2. การดำเนินงานด้านการให้บริการของ อ.ส.ค.');
        $objPHPExcel->getActiveSheet()->setCellValue('A4', '   2.5 ปัจจัยการผลิต');
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '             ปี ' . ($condition['YearFrom'] + 543) . ' อ.ส.ค.มีการดำเนินงาน ดังนี้ ');
...
//tb header
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B15', 'ปี ' . ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->mergeCells('B15:C15');
        $objPHPExcel->getActiveSheet()->setCellValue('D15', 'ปี ' . ($condition['YearFrom'] + 542));
...
//        );
    ...
    private function generateCooperativeMilkExcel($objPHPExcel, $condition) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                       ปี ' . ($condition['YearFrom'] + 543) . ' มีจำนวนเกษตรกร/สมาชิก, จำนวนโค และการรับซื้อน้ำนม มีรายละเอียด ดังนี้ ');
...
//tb header
        ...
        foreach ($region as $reg) {
            ...
            $sumAverageValues = 0;
            $line = 0;
            $data = CooperativeMilkController::getAnnuallyDataListreport($condition, $reg);
...
//tb header
        ...
        $sumTotalValues = 0;
        $sumAverageValues = 0;
        $data = CooperativeMilkController::getAnnuallyDataListreport($condition, $region);
        if ($data['DataList'][0]['RegionName'] != '') {
            $objPHPExcel->getActiveSheet()->setCellValue('A' . (10 + $row), $data['DataList'][0]['RegionName']);
            $objPHPExcel->getActiveSheet()->getStyle('A' . (10 + $row))->getFont()->setBold(true);
            $row++;
    ...
    private function generateCowgroupExcel($objPHPExcel, $condition, $region) {
        ...
        $data = CowGroupController::getDataListannual($condition, $region);
        $objPHPExcel->getActiveSheet()->setTitle("3.2 โค");
        $objPHPExcel->getActiveSheet()->setCellValue('A3', '3. การดำเนินงานด้านกิจการโคนมของ อ.ส.ค.');
        $objPHPExcel->getActiveSheet()->setCellValue('A4', ' 3.2 ฝูงโค อ.ส.ค.');
        $objPHPExcel->getActiveSheet()->setCellValue('A5', ' ฝูงโค อ.ส.ค. ณ 31 ' . '  ปี ' . ($condition['YearFrom'] + 543) . ' จำนวน ' . $data['Summary']['SummaryCurrentCowService'] . ' ตัว เมื่อเปรียบเทียบกับเดือนเดียวกันของปีที่ผ่านมา');
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B11', 'ไตรมาส ที่ ' . $condition['QuarterFrom'] . ' ปี ' . ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->mergeCells('B11:C11');
        $objPHPExcel->getActiveSheet()->setCellValue('D11', 'ไตรมาส ที่ ' . $condition['QuarterFrom'] . ' ปี ' . ($condition['YearFrom'] + 542));
...
// // header style
    ...
    private function generateCowgroup2Excel($objPHPExcel, $condition, $region) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B6', ' ปี ' . ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->mergeCells('B6:C6');
        $objPHPExcel->getActiveSheet()->setCellValue('D6', ' ปี ' . ($condition['YearFrom'] + 542));
...
//        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                        อ.ส.ค.รับซื้อน้ำนมเดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . '  ปริมาณ ' . number_format($data['DataList'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['DataList'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ');
...
//print_r($data['data'][$size - 1]['CurrentAmount']);
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A6', '                         ปี ' . ($condition['YearFrom'] + 543) . 'ภาคกลาง  ปริมาณ ' . number_format($data['data'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['data'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ดังนี้');
...
// // header style
    ...
    private function generateMilk6Excel($objPHPExcel, $condition, $data) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                         4.1.2 ภาคใต้');
        $objPHPExcel->getActiveSheet()->getStyle('A5:A6')->getFont()->setSize(16);
        $objPHPExcel->getActiveSheet()->setCellValue('A6', '                         ปี ' . ($condition['YearFrom'] + 543) . 'ภาคใต้  ปริมาณ ' . number_format($data['data'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['data'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ดังนี้');
        $row = 0;
        foreach ($data['subdetail'] as $key => $item) {
            $objPHPExcel->getActiveSheet()->setCellValue('B' . (7 + $row), ($key + 1) . '. ' . $item['VENDOR_NAME'] . ' ปริมาณ ' . number_format($item['sum_amount'], 2, '.', ',') . ' มูลค่า ' . number_format($item['sum_baht'], 2, '.', ','));
...
// // header style
    ...
    private function generateMilk9Excel($objPHPExcel, $condition, $data) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                          4.1.3 ภาคตะวันออกเฉียงเหนือ');
        $objPHPExcel->getActiveSheet()->getStyle('A5:A6')->getFont()->setSize(16);
        $objPHPExcel->getActiveSheet()->setCellValue('A6', '                         ปี ' . ($condition['YearFrom'] + 543) . 'ภาคตะวันออกเฉียงเหนือ  ปริมาณ ' . number_format($data['data'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['data'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ดังนี้');
        $row = 0;
        foreach ($data['subdetail'] as $key => $item) {
...
// // header style
    ...
    private function generateMilk12Excel($objPHPExcel, $condition, $data) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                           4.1.4 ภาคเหนือตอนล่าง');
        $objPHPExcel->getActiveSheet()->getStyle('A5:A6')->getFont()->setSize(16);
        $objPHPExcel->getActiveSheet()->setCellValue('A6', '                         ปี ' . ($condition['YearFrom'] + 543) . 'ภาคเหนือตอนล่าง  ปริมาณ ' . number_format($data['data'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['data'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ดังนี้');
        $row = 0;
        foreach ($data['subdetail'] as $key => $item) {
            $objPHPExcel->getActiveSheet()->setCellValue('B' . (7 + $row), ($key + 1) . '. ' . $item['VENDOR_NAME'] . ' ปริมาณ ' . number_format($item['sum_amount'], 2, '.', ',') . ' มูลค่า ' . number_format($item['sum_baht'], 2, '.', ','));
...
// // header style
    ...
    private function generateMilk15Excel($objPHPExcel, $condition, $data) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A6', '                         ปี ' . ($condition['YearFrom'] + 543) . 'ภาคเหนือตอนบน  ปริมาณ ' . number_format($data['data'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['data'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ดังนี้');
        $row = 0;
        foreach ($data['subdetail'] as $key => $item) {
            $objPHPExcel->getActiveSheet()->setCellValue('B' . (7 + $row), ($key + 1) . '. ' . $item['VENDOR_NAME'] . ' ปริมาณ ' . number_format($item['sum_amount'], 2, '.', ',') . ' มูลค่า ' . number_format($item['sum_baht'], 2, '.', ','));
...
//        $objPHPExcel->getActiveSheet()->getStyle('A7:I8')->getFont()->setBold(true);
    ...
    private function generatesaleMilkExcel($objPHPExcel, $condition, $region) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('A5', '                        อ.ส.ค.การจำหน่ายน้ำนมปี ' . ($condition['YearFrom'] + 543) . '  ปริมาณ ' . number_format($data['DataList'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['DataList'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ');
        //  $objPHPExcel->getActiveSheet()->setCellValue('A6', '                  เมื่อเปรียบเทียบกับเดือนเดียวกันของปีที่ผ่านมา ปรากฏว่าปริมาณ และมูลค่าคิดเป็นร้อยละ ' . number_format($data['DataList'][$size - 1]['DiffAmountPercentage'], 2, '.', ',') . ' และ ' . number_format($data['DataList'][$size - 1]['DiffBahtPercentage'], 2, '.', ',') . ' ตามลำดับ');
        $objPHPExcel->getActiveSheet()->setCellValue('A7', '                       เดือน ' . 'ต.ค. ' . ($showm + 543) . " - " . $this->getMonthshName($start) . ' ' . ($showy + 543) . ' มีปริมาณ ' . number_format($data['Summary']['SummaryAmount'], 2, '.', ',') . ' กิโลกรัม มูลค่า ' . number_format($data['Summary']['SummaryBaht'], 2, '.', ',') . '  บาท');
...
// // header style
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B' . ($highestRow), '                        เดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . ' โรงงานนมปราณบุรีจำน่ายน้ำนม  ปริมาณ ' . number_format($data['data'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['data'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ');
        //  $objPHPExcel->getActiveSheet()->setCellValue('A6', '                  เมื่อเปรียบเทียบกับเดือนเดียวกันของปีที่ผ่านมา ปรากฏว่าปริมาณ และมูลค่าคิดเป็นร้อยละ ' . number_format($data['DataList'][$size - 1]['DiffAmountPercentage'], 2, '.', ',') . ' และ ' . number_format($data['DataList'][$size - 1]['DiffBahtPercentage'], 2, '.', ',') . ' ตามลำดับ');
...
// // header style
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B' . ($highestRow), '                        เดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . ' โรงงานนมสุโขทัย จำน่ายน้ำนม  ปริมาณ ' . number_format($data['data'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['data'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ');
        //  $objPHPExcel->getActiveSheet()->setCellValue('A6', '                  เมื่อเปรียบเทียบกับเดือนเดียวกันของปีที่ผ่านมา ปรากฏว่าปริมาณ และมูลค่าคิดเป็นร้อยละ ' . number_format($data['DataList'][$size - 1]['DiffAmountPercentage'], 2, '.', ',') . ' และ ' . number_format($data['DataList'][$size - 1]['DiffBahtPercentage'], 2, '.', ',') . ' ตามลำดับ');
        $objPHPExcel->getActiveSheet()->getStyle('B' . ($highestRow))->getFont()->setSize(16);
        $highestRow += 2;
...
// // header style
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B' . ($highestRow), '                        เดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . ' โรงงานนมเชียงใหม่ จำน่ายน้ำนม  ปริมาณ ' . number_format($data['data'][$size - 1]['CurrentAmount'], 2, '.', ',') . '  กิโลกรัม มูลค่า ' . number_format($data['data'][$size - 1]['CurrentBaht'], 2, '.', ',') . '  บาท ');
        //  $objPHPExcel->getActiveSheet()->setCellValue('A6', '                  เมื่อเปรียบเทียบกับเดือนเดียวกันของปีที่ผ่านมา ปรากฏว่าปริมาณ และมูลค่าคิดเป็นร้อยละ ' . number_format($data['DataList'][$size - 1]['DiffAmountPercentage'], 2, '.', ',') . ' และ ' . number_format($data['DataList'][$size - 1]['DiffBahtPercentage'], 2, '.', ',') . ' ตามลำดับ');
        $objPHPExcel->getActiveSheet()->getStyle('B' . ($highestRow))->getFont()->setSize(16);
        $highestRow += 2;
...
//         
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B5', '                        เดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . ' .ผลิตผลิตภัณฑ์นมชนิดต่าง ๆ ได้รวมกันทั้งสิ้น ปริมาณ ' . number_format($total, 2, '.', ',') . '  ลิตร ');
...
//tb header
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B' . (7 + $row), $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->mergeCells('B' . (7 + $row) . ':C' . (7 + $row));
        $objPHPExcel->getActiveSheet()->setCellValue('D' . (7 + $row), $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 542));
...
//
    ...
    private function generateproductMilk2Excel($objPHPExcel, $condition, $detail1, $detail2, $totalc, $totalb) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('D3', $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 542));
...
//         
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B5', '                        เดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . ' - ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearTo'] + 543) . ' ผลิตผลิตภัณฑ์นมชนิดต่าง ๆ ได้รวมกันทั้งสิ้น ปริมาณ ' . number_format($total, 2, '.', ',') . '  ลิตร ');
...
//         
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B5', '                        เดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . ' จำหน่ายผลิตภัณฑ์นมชนิดต่าง ๆ ได้รวมกันทั้งสิ้น ปริมาณ ' . number_format($total, 2, '.', ',') . '  ลิตร ');
...
//         
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B5', '                        เดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . ' - ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearTo'] + 543) . ' อ.ส.ค.จำหน่ายผลิตภัณฑ์นมชนิดต่าง ๆ ได้รวมกันทั้งสิ้น ปริมาณ ' . number_format($total, 2, '.', ',') . '  ลิตร ');
...
//        $objPHPExcel->getActiveSheet()->setCellValue('B' . (7 + $size), ' ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543));
//        $objPHPExcel->getActiveSheet()->mergeCells('B' . (7 + $size) . ':C' . (7 + $size));
//        $objPHPExcel->getActiveSheet()->setCellValue('D' . (7 + $size), ' ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 542));
...
//        $row++;
//
//        $objPHPExcel->getActiveSheet()->setCellValue('B4', '                        เดือน ' . $this->getMonthName($condition['MonthFrom']) . ' ' . ($condition['YearFrom'] + 543) . ' อ.ส.ค.มีการสูญเสียทั้งกระบวนการผลิตทั้งสิ้น ปริมาณ  ' . number_format($tcurrent, 2, '.', ',') . '  ลิตร ');
...
//tb2 header
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B' . ($tb2row + 3 + $size), ' ' . $this->getMonthName(10) . ' - ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->mergeCells('B' . ($tb2row + 3 + $size) . ':C' . ($tb2row + 3 + $size));
        $objPHPExcel->getActiveSheet()->setCellValue('D' . ($tb2row + 3 + $size), ' ' . $this->getMonthName(10) . ' - ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearFrom'] + 542));
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B' . ($tb2row), '                        เดือน ' . $this->getMonthName(10) . ' - ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearFrom'] + 543) . ' อ.ส.ค.มีการสูญเสียทั้งกระบวนการผลิตทั้งสิ้น ปริมาณ  ' . number_format($tcurrent, 2, '.', ',') . '  ลิตร ');
...
///////////////////////
    ...
    private function generatelostINproductionExcel($objPHPExcel, $condition, $region) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B5', ' ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearFrom'] + 543));

        $objPHPExcel->getActiveSheet()->setCellValue('C5', ' ' . $this->getMonthName(10) . ' - ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearFrom'] + 543));
...
//    
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B' . ($row), ' ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearFrom'] + 543));

        $objPHPExcel->getActiveSheet()->setCellValue('C' . ($row), ' ' . $this->getMonthName(10) . ' - ' . $this->getMonthName($condition['MonthTo']) . ' ' . ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->getStyle('A' . $row . ':C' . $row)->getFont()->setSize(16);
        $objPHPExcel->getActiveSheet()->getStyle('A' . $row . ':C' . $row)->getFont()->setBold(true);
        $objPHPExcel->getActiveSheet()
...
//            array_push($datacollect, $datacollectIN);
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('B4', ($condition['YearFrom'] + 543));
        $objPHPExcel->getActiveSheet()->mergeCells('B4:C4');
        $objPHPExcel->getActiveSheet()->setCellValue('D4', ($condition['YearFrom'] + 542));
...
//            array_push($datacollect, $datacollectIN);
        ...
        $objPHPExcel->getActiveSheet()->setTitle('สูญเสียหลัง ');
        $objPHPExcel->getActiveSheet()->setCellValue('A3', '  5.3.2 สูญเสียหลังกระบวนการผลิต');
        $objPHPExcel->getActiveSheet()->setCellValue('A4', 'รายการ');
        $objPHPExcel->getActiveSheet()->mergeCells('A4:A5');
        $objPHPExcel->getActiveSheet()->setCellValue('B4', ($condition['YearFrom'] + 543));
    ...
    private function generatelostWAITproductionExcel($objPHPExcel, $condition, $region) {
        ...
        foreach ($FactoryList as $key => $fac) {
            $condition['Factory'] = $fac['id'];
            $dataOUT = LostWaitSaleController::getAnnuallyDataList($condition, 3);
            $dataOUT['name'] = $fac['factory_name'];
            array_push($data, $dataOUT);
//            $datacollectIN = LostInProcessController::getMonthDataListreport($condition);
//            array_push($datacollect, $datacollectIN);
...
//            array_push($datacollect, $datacollectIN);
        ...
        $objPHPExcel->getActiveSheet()->setTitle('สูญเสียรอ ');
        $objPHPExcel->getActiveSheet()->setCellValue('A3', '   5.3.3 สูญเสียระหว่างรอจำหน่าย');
        $objPHPExcel->getActiveSheet()->setCellValue('A4', 'รายการ');
        $objPHPExcel->getActiveSheet()->mergeCells('A4:A5');
        $objPHPExcel->getActiveSheet()->setCellValue('B4', ' ' . ($condition['YearFrom'] + 543));
