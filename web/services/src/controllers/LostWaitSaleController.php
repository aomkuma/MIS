...
class LostWaitSaleController extends Controller {
    ...
    public function getExcelTemplate($request, $response, $args) {
        ...
        try {
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('A1', 'รายการสูญเสียระหว่างรอจำหน่ายประจำเดือน');
            ...
            $objPHPExcel->getActiveSheet()->setCellValue('A4', 'รายการสูญเสียระหว่างรอจำหน่าย');
            ...
            $objPHPExcel->getActiveSheet()->mergeCells('E4:F5');
            $objPHPExcel->getActiveSheet()->mergeCells('G4:H5');
            $objPHPExcel->getActiveSheet()->mergeCells('I4:K5');
            ...
            $MasterGoalList = MasterGoalService::getList('Y', 'การสูญเสียรอจำหน่าย', [], '', $factory_id);//MasterGoalService::getListOrderByName('Y', 'การสูญเสียหลังกระบวนการ', [], '', $factory_id);
            // print_r($ProductMilk);exit;
            ...
            $objPHPExcel->getActiveSheet()->getStyle('A1:K5' . $highestRow)->getAlignment()->setHorizontal(\PHPExcel_Style_Alignment::HORIZONTAL_CENTER);
