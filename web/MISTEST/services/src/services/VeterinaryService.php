...
class VeterinaryService {
    ...
    public static function getDetailmonth($years, $months, $type_id, $region, $dairy_farming_id = []) {
        $ckid = null;
    ...
    public static function getDetailmonthPrice($years, $months, $type_id, $region, $dairy_farming_id = []) {
        $ckid = null;
        return Veterinary::select(DB::raw("SUM(mis_veterinary_item.item_amount) AS amount")
                        )
                        ->join("veterinary_detail", 'veterinary_detail.veterinary_id', '=', 'veterinary.id')
