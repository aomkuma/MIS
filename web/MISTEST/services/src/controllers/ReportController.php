...
//            $objPHPExcel = $this->generateSpermExcel($objPHPExcel, $mastesgoallist, $header, $data);
            ...
            $this->data_result['DATA'] = 'MISTEST/files/files/download/' . $filename;
    ...
    private function generateCowgroupExcel($objPHPExcel, $mastesgoallist, $header, $data, $type, $commemt) {
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('G4', 'จำนวนโคสด');
        $objPHPExcel->getActiveSheet()->setCellValue('L4', 'จำนวนโคยกไป');

        $objPHPExcel->getActiveSheet()->setCellValue('C5', 'เกิด');
        $objPHPExcel->getActiveSheet()->setCellValue('D5', 'รับเข้าจากหน่วยงาน');
        $objPHPExcel->getActiveSheet()->setCellValue('E5', 'รับเข้าฝูง');
        ...
        $objPHPExcel->getActiveSheet()->setCellValue('I5', 'ย้ายออกไปหน่วยงาน');
        $objPHPExcel->getActiveSheet()->setCellValue('J5', 'ย้ายฝูง');
        $objPHPExcel->getActiveSheet()->setCellValue('K5', 'รวม (-)');
        ...
        foreach ($MasterSubGoalType as $key => $value) {
            ...
            foreach ($MasterGoalList as $key1 => $value1) {
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('F' . $cnt, $data_result['beginning_period']);
                ...
                $objPHPExcel->getActiveSheet()->setCellValue('I' . $cnt, $data_result['total_sell_carcass']);
                $objPHPExcel->getActiveSheet()->setCellValue('J' . $cnt, $data_result['total_moveout']);
                $objPHPExcel->getActiveSheet()->setCellValue('K' . $cnt, $data_result['beginning_period']);
