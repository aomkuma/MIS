angular.module('e-homework').controller('MainCGController', function($scope, $cookies, $filter, $state, $uibModal, HTTPService, IndexOverlayFactory) {
    //console.log('Hello !');
    ...
    $scope.loadApproveList = function(){
      ...
      //  IndexOverlayFactory.overlayShow();
        HTTPService.clientRequest('cow-group/list/approve', null).then(function(result){
            if(result.data.STATUS == 'OK'){
