angular.module('e-homework').controller('UpdateTNController', function($scope, $cookies, $filter, $state, $routeParams, $uibModal, HTTPService, IndexOverlayFactory) {
    //console.log('Hello !');
    ...
    if($scope.ID !== undefined && $scope.ID !== null){
        $scope.loadData('training/get', $scope.ID);
    }
