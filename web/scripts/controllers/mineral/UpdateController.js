angular.module('e-homework').controller('UpdateController', function($scope, $cookies, $filter, $state, $routeParams, $uibModal, HTTPService, IndexOverlayFactory) {
    ...
    $scope.loadData = function(action, id){
        ...
        HTTPService.clientRequest(action, params).then(function(result){
            if(result.data.STATUS == 'OK' && result.data.DATA.Data != null){
                ...
                $scope.MineralDetailList = $scope.Mineral.insemination_detail;
    ...
    $scope.save = function(Mineral, MineralDetailList){
        ...
        var params = {'Mineral' : Mineral, 'MineralDetailList' : MineralDetailList};
        IndexOverlayFactory.overlayShow();
    ...
    $scope.addMineralItem = function(index){
        ...
        $scope.MineralDetailList[index].insemination_item.push(item);
    }
    ...
    $scope.removeItem = function(id, parent_index, child_index){
        if(id == ''){
            $scope.MineralDetailList[parent_index].insemination_item.splice(child_index, 1);
        }else{
