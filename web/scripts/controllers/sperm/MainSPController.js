angular.module('e-homework').controller('MainSPController', function($scope, $cookies, $filter, $state, $uibModal, HTTPService, IndexOverlayFactory) {
    //console.log('Hello !');
    ...
    $scope.loadApproveList = function(){
      ...
      //  IndexOverlayFactory.overlayShow();
        HTTPService.clientRequest('sperm/list/approve', null).then(function(result){
            if(result.data.STATUS == 'OK'){
    ...
    $scope.goUpdate = function(id){
        window.location.href = '#/sperm/update/' + id;
    }
