...
<p>There are many examples of Chart.js that are available in the <code>/samples</code> folder of <code>Chart.js.zip</code> that is attached to every <a href="https://github.com/chartjs/Chart.js/releases" target="_blank">release</a>.</p>
